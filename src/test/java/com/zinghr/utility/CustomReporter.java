...
public class CustomReporter extends CustomReporterListener {
	...
	protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(
				outdir, "KiwiQA-Customize-Report" + ".html"))));
	}
	...
	public void testCaseNo() {
		...
		m_out.println("<td bgcolor='#99CCFF' colspan='4' align='left' height='30px'><h3 style='margin-top:0px;margin-bottom:0px;'><br> Total Test Cases  : "
				+ (failedCounter + passed)
				+ "</br><br> Failed Test Cases  : "
				+ (failedCounter)
				+ "</br><br> Passed Test cases : "
				+ passed
				+ "</br></h3></td>");
	...
	private void resultSummary(ISuite suite, IResultMap tests, String testname,
		...
		if (tests.getAllResults().size() > 0) {
			...
			for (ITestNGMethod method : getMethodSet(tests, suite)) {
				 ...
				 */
				m_out.println("<td class=\"numi\"><center>" + (end - start)
						/ 1000 + "</center></td>" + "</tr>");
	...
	private void startResultSummaryTable(String style) {
		...
		/*
		 * m_out.println(
		 * "<tr><td colspan='4'>&nbsp&nbsp&nbsp&nbspOverall test suite completion : <b>"
		 * + Time +
		 * " minutes</b><br></br>&nbsp;&nbsp;&nbsp;&nbsp; Date and Time of Run: <b>"
		 * + sdf.format(date) +
		 * "</b><br></br>&nbsp;&nbsp;&nbsp;&nbsp; Browser Name : <b>" +
		 * SeleniumInit.browserName +
		 * "</b><br></br>&nbsp;&nbsp;&nbsp;&nbsp; Browser Version : <b>41.0</b><br></br>&nbsp;&nbsp;&nbsp;&nbsp; OS: <b>"
