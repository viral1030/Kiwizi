...
public class ReadXMLFile {
	...
	public void suiteDetails(Document doc) throws IOException {
		...
		aw.write(" "
				+ " <footer style='background:#FFFFFF;width:100%;height:40px;position:fixed;bottom:0;left:0;'> "
				+ " <div style='padding-top:10px;padding-right:10px;float:right;'> "
				+ "  <b>Version</b> 2.0"
				+ " </div>"
				+ " <div style='padding-top:10px;padding-left:10px'>"
				+ "<strong >Copyright &copy; 2014-2015 <a>KIWIQA</a>. </strong> All rights reserved."
				+ " <div> " + "</footer>");

		/*
		 * aw.write(" " + "	<footer class='main-footer'> " +
		 * "	<div class='pull-right hidden-xs'> " + "		<b>Version</b> 2.0" +
		 * "	</div>" +
		 * "	<strong>Copyright &copy; 2014-2015 <a href=>KIWIQA</a>." +
